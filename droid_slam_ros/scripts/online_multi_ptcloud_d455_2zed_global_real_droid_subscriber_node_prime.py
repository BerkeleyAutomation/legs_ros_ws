...
class MinimalSubscriber(Node):
    ...
    def __init__(self):
        ...
        self.publisher = self.create_publisher(ImagePoses, '/camera/color/imagepose',10)
        ...
        self.left_zed_rgb_sub = message_filters.Subscriber(
            self, CompressedImage, "/tri_left_zed_cropped"
        )
        self.left_zed_depth_sub = message_filters.Subscriber(
            self, Image, "/tri_left_zed_depth"
        )
        ...
        self.right_zed_rgb_sub = message_filters.Subscriber(
            self, CompressedImage, "/tri_right_zed_cropped"
        )
        self.right_zed_depth_sub = message_filters.Subscriber(
            self, Image, "/tri_right_zed_depth"
        )
        self.realsense_publisher = self.create_publisher(ImagePoses, '/sim_realsense',10)
        self.last_pose = None
        self.t_ = 0
        ...
        self.sim_realsense_sub = self.create_subscription(ImagePoses,'/sim_realsense',self.sim_realsense_callback,10)

...
class MinimalSubscriber(Node):
    ...
    def __init__(self):
        ...
        self.ts = message_filters.ApproximateTimeSynchronizer([self.rgb_sub, self.depth_sub], 500, 3.0)
    ...
    def sim_realsense_callback(self,full_msg):
        ...
        original_intrinsics = torch.tensor([self.cam_params['fl_x'],self.cam_params['fl_y'],self.cam_params['cx'],self.cam_params['cy']])#,[0,0,1]]])

...
class MinimalPublisher(Node):
    ...
    def __init__(self):
        ...
        d455_folder = '/home/kushtimusprime/2024_03_12_bags/alienware_sensitivity_bags/dense_kitchen_loop_d435_2zed'
        image_list = sorted(glob.glob(os.path.join(d455_folder, 'camera_color', '*.png')))[::1]
        depth_list = sorted(glob.glob(os.path.join(d455_folder, 'camera_depth', '*.npy')))[::1]
        total_image_stream = []

...
class MinimalSubscriber(Node):
    ...
    def sim_realsense_callback(self,full_msg):
        ...
        # image_pose_msg.w = self.left_zed_cam_params['w']
        # image_pose_msg.h = self.left_zed_cam_params['h']
        # image_pose_msg.fl_x = self.left_zed_cam_params['fl_x']
        # image_pose_msg.fl_y = self.left_zed_cam_params['fl_y']
        # image_pose_msg.cx = self.left_zed_cam_params['cx']
        # image_pose_msg.cy = self.left_zed_cam_params['cy']
        ...
        image_poses.image_poses = [image_pose_msg, realsense_pose_msg]
    ...
    def image_callback_uncompressed(self, left_zed_img_msg, left_zed_depth_msg, realsense_img_msg, realsense_depth_msg):
        ...
        imageposes_msg.image_poses = [left_zed_sim_msg,realsense_sim_msg]

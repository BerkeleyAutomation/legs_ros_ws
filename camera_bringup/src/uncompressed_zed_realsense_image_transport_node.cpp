...
int main(int argc, char ** argv)
{
  ...
  image_transport::Subscriber sub_left = it.subscribe("/repub_left_zed_left_color", 10, leftCallback);
  image_transport::Subscriber sub_right = it.subscribe("/repub_left_zed_right_color", 10, rightCallback);
  rclcpp::spin(node);
